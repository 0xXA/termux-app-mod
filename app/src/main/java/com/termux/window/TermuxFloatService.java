...
public class TermuxFloatService extends Service {
    ...
    public void onCreate() {
        ...
        TermuxFloatView floatingWindow = (TermuxFloatView) ((LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.float_activity_main, null);
